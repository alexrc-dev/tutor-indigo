...
config = {
    ...
    "defaults": {
        ...
        "PRIMARY_COLOR": "#1b9def",  # cool blue
        ...
        "FOOTER_LEGAL_LINKS": [
            ...
            {
                "title": "Indigo-CodeaLA theme for Open edX",
...
hooks.Filters.ENV_TEMPLATE_TARGETS.add_items(
    [
        ("indigo-codeala-codeala", "build/openedx/themes"),
    ],
)

# Force the rendering of scss files, even though they are included in a "partials" directory
# hooks.Filters.ENV_PATTERNS_INCLUDE.add_item(r"indigo-codeala/lms/static/sass/partials/lms/theme/")
